		...
		<div className="bg-black text-white min-h-screen font-sans">
			...
			<section id="services" className="py-20 px-6 bg-zinc-950 ">
				<div className="max-w-7xl mx-auto text-center ">
					...
					<div className="text-center">
						...
						<div className="flex justify-center">
							<motion.p
								...
								className="text-xl  text-gray-400 mb-16 text-center max-w-[550px]"
							>
								We prioritize flexibility, streamlined processes, and creative
								that positively impacts your business. From commercials to
								animation, documentaries to branded content, we&#39;ve got you
								covered.
							</motion.p>
						</div>
					...
					<div className="flex gap-[2px] justify-center scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
			...
			<section id="about" className="py-20 px-6">
				<div className="max-w-7xl mx-auto">
					...
					>
						We hear you
						<br />
						<span className=""> loud & clear </span>
					</motion.h2>
					<motion.p
						initial={{ opacity: 0, y: 20 }}
						whileInView={{ opacity: 1, y: 0 }}
